...
<div class="container align-item-center">
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">Transaction Type Edit</div>
                <div class="card-body">
                	<form method="post" action="{{ url('transaction_type_edit_save') }}" autocomplete="off">
                		{{ csrf_field() }}
	                	<div class="form-row">
	                		<div class="form-group col-md-12">
								<label for="documentCode">Transaction Type *</label>
								<input type="text" class="form-control" id="transactionType" name="transactionType" value="{{$tt}}" required="required">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-12">
								...
								<input type="number" class="form-control" id="days" name="days" value="{{$days}}" required="required">
							</div>
