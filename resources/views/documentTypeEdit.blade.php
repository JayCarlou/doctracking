...
<div class="container align-item-center">
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">Document Type Edit</div>
                <div class="card-body">
                	<form method="post" action="{{ url('document_type_edit_save') }}" autocomplete="off">
                		{{ csrf_field() }}
	                	<div class="form-row">
	                		<div class="form-group col-md-12">
								<label for="documentCode">Document Code *</label>
                                <input type="hidden" name="documentTypeId" id="documentTypeId" value="{{$id}}">
								<input type="text" class="form-control" id="documentTypeCode" name="documentTypeCode" value="{{$dc}}" required="required" maxlength="5">
							</div>
						...
						<div class="form-row">
							...
							<div class="form-group col-md-12">
								...
								<input type="text" class="form-control" id="documentType" name="documentType" value="{{$dt}}" required="required">
							</div>
