    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ url('create_user_save') }}" autocomplete="off">
                        {{ csrf_field() }}
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="officeName">Password *</label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control" name="office" id="office" required="required" disabled="disabled">
                                    <option value="">Select One</option>
                                ...
                                <td>
                                    <center>
                                        <a href="{{URL::to('edit_user/'.$list->aid)}}">
                                            <button type="button" class="btn btn-primary btn-sm" title="edit details">
                                        ...
                                        <a href="{{URL::to('user_delete/'.$list->aid)}}">
                                            <button type="button" class="btn btn-danger btn-sm" title="delete account">
