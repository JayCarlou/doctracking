...
<div class="container align-item-center">
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">Delivery Method Entry</div>
                <div class="card-body">
                	<form method="post" action="{{ url('delivery_method_entry_save') }}" autocomplete="off">
                		{{ csrf_field() }}
	                	<div class="form-row">
	                		<div class="form-group col-md-12">
								<label for="deliveryMethod">Delivery Method *</label>
								<input type="text" class="form-control" id="deliveryMethod" name="deliveryMethod" required="required" maxlength="5">
							</div>
						...
						<div class="form-row">
	                		<div class="form-group col-md-12">
								<button type="submit" class="btn btn-primary btn-block" onclick="click()">
                                    <i class="fa fa-btn fa-save"></i> Save Delivery Method
                                </button>
							</div>
